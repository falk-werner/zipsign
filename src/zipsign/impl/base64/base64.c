#include "zipsign/impl/base64/base64.h"
...
size_t base64_decoded_size(char const * data, size_t length)
{
    size_t result = 0;
...
size_t base64_decode(
    ...
    size_t buffer_size)
{
    uint8_t const * table = base64_decode_table;
    size_t needed_size = base64_decoded_size(data, length);
    ...
    {
        uint8_t a = table[ data[pos    ] ];
        uint8_t b = table[ data[pos + 1] ];
        uint8_t c = table[ data[pos + 2] ];
        uint8_t d = table[ data[pos + 3] ];
